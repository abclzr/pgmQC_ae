...
int main()
{
   ...
   **********************/
   ...
   modes_list.push_back(modesA);
   modes_list.push_back(modesB);
   modes_list.push_back(modesC);
   modes_list.push_back(modesD);
   ...
   extent_list.push_back(extentA);
   extent_list.push_back(extentB);
   extent_list.push_back(extentC);
   extent_list.push_back(extentD);
   extent_list.push_back(extentR);
   ...
   *******************************/
   ...
   const int32_t** modesIn = (const int32_t**) malloc(sizeof(const int32_t*) * n);
   for (int i = 0; i < n; ++i)
